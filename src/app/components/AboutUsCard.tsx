...
import styles from "../styles/AboutUsCard.module.css"
interface Props {
    name: string;
    rol: string;
    parragraph: string;
...
function AboutUsCard({ name, rol, parragraph, parragraph2 }: Props) {
    return (
        ...
        <section className={styles.section}>
            ...
            <div className={styles.parragraphContainer}>
                <p className={styles.parragraph}>{parragraph}</p>
                <p className={styles.parragraph}>{parragraph2}</p>
            </div>
        </section >
    );
}
